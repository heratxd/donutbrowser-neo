...
<<<<<<< HEAD
    // Management TCC notification ("NeoDonut Browser.app was prevented from modifying
=======
...
<<<<<<< HEAD
    // prompt ("NeoDonut Browser.app was prevented from modifying apps on your Mac"),
=======
