...
<<<<<<< HEAD
  let mount_point = PathBuf::from("/Volumes/NeoDonutEphemeral");
=======
...
<<<<<<< HEAD
    .args(["erasevolume", "HFS+", "NeoDonutEphemeral", &dev])
=======
...
<<<<<<< HEAD
    let base = PathBuf::from(format!("{}:\\NeoDonutEphemeral", letter));
=======
...
<<<<<<< HEAD
        let base = PathBuf::from(format!("{}\\NeoDonutEphemeral", drive));
=======
